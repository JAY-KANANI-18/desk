...
export const MOCK_DATA = {
  ...
  snippets: [
    { id: '1', shortcut: '/greeting', name: 'Greeting', title: 'Greeting', content: 'Hi {{contact.name}}! Thanks for reaching out. How can I help you today?', topic: 'Support', attachments: [] },
