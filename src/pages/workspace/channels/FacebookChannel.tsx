...
const PERMISSIONS = ['pages_messaging', 'pages_read_engagement', 'pages_manage_metadata'];
...
export const FacebookChannel = ({ connected, onConnect, onDisconnect }: Props) => {
  ...
  const handleFBLogin = () => {
    ...
    const doConnect = async (auth: FBAuthResponse) => {
      try {
        const channel = await channelApi.connectFacebook(auth);
        onConnect(channel);
      } catch {
    ...
    return (
      <div className="space-y-4">
        <div className="flex items-center gap-3 pb-4 border-b border-gray-100">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900">Facebook Messenger</h3>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 flex items-start gap-3">
          ...
          <div>
            <p className="text-sm font-medium text-blue-800">Facebook Messenger is active</p>
        ...
        <div className="bg-red-50 border border-red-200 rounded-xl p-4 flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-red-600 mt-0.5">This will stop receiving Messenger messages.</p>
          </div>
          <button
  ...
  return (
    <div className="space-y-4">
      <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
        <p className="text-sm font-semibold text-blue-800 mb-1">Facebook Messenger</p>
        <p className="text-xs text-blue-700 leading-relaxed">
          Connect your Facebook Page to receive and reply to Messenger conversations directly from your inbox. Requires a Facebook Page with Messenger enabled.
        </p>
      </div>
