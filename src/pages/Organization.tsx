...
//           Configure organization-wide admin preferences.
//         </p>
//       </div>
...
//             desc: "Agents can delete their own sent messages.",
//           },
//           {
//             label: "Allow agents to edit messages",
//             desc: "Agents can edit messages after sending.",
//           },
//           {
//             label: "Require conversation closing note",
//             desc: "Agents must add a note before closing a conversation.",
//           },
//           {
//             label: "Auto-assign on reply",
//             desc: "Automatically assign a conversation to the agent who replies.",
//           },
//         ].map((item) => (
//           <div
//             key={item.label}
...
//               Require all members to enable 2FA on their accounts.
//             </p>
//           </div>
//           <label className="relative inline-flex items-center cursor-pointer ml-4 flex-shrink-0">
...
//         </div>
//         <button
//           onClick={() => navigate("/organization/workspace-add")}
...
// export const WorkspaceAddSection = () => {
//   return (
//     <div>
...
// export const WhatsAppFeesSection = () => {
//   return (
//     <div>
//       <div className="border-b border-gray-200 pb-4 mb-6 flex items-center gap-2">
...
//           </h2>
//           <p className="text-sm text-gray-500 mt-0.5">
//             Manage WABA balance associated with the phone number of the channel
//             belongs to.
//           </p>
//         </div>
//       </div>
...
export const BillingUsageSection = () => {
  return (
    <div>
      <div className="border-b border-gray-200 pb-4 mb-6">
        <h2 className="text-base font-semibold text-gray-900">
