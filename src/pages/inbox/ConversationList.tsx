              ...
              <>
                {visibleConversations.map((conv) => {
                  const effectiveChannel =
                    channels?.[conv.id] ?? conv?.channel?.type;
                  const cfg =
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center justify-between mb-0.5">
                            ...
                            <div className="flex items-center gap-1.5 flex-shrink-0 ml-2">
                              <span
                                className={`text-xs ${isUnread ? "text-blue-600 font-semibold" : "text-gray-400"}`}
                              >
                                {conv.time}
                              </span>
                          ...
                          <div className="flex items-center gap-1 mb-1.5">
                            ...
                            <p
                              className={`text-xs truncate ${isUnread ? "text-gray-800 font-medium" : "text-gray-500"}`}
                            >
          ...
          >
            {visibleCallLogs.map((call) => {
              ...
              return (
                <div
                  key={call.id}
                  className="p-4 border-b border-gray-100 cursor-pointer hover:bg-gray-50 flex items-center gap-3"
                >
                  <div className="relative flex-shrink-0">
                    ...
                    <span
                      className={`absolute -bottom-1 -right-1 w-5 h-5 rounded-full flex items-center justify-center border-2 border-white ${isMissed ? "bg-red-100" : isIncoming ? "bg-green-100" : "bg-blue-100"}`}
                    >
                      {isMissed ? (
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-1.5">
                      {isMissed ? (
                        ...
                        <>
                          <span
                            className={`text-xs font-medium ${isIncoming ? "text-green-600" : "text-blue-600"}`}
                          >
                  ...
                  <button className="p-1.5 hover:bg-gray-100 rounded-lg text-gray-400 hover:text-gray-600 flex-shrink-0">
                    <Phone size={15} />
                  </button>
                </div>
              );
