...
const CATALOG_CHANNELS: CatalogChannel[] = [
...

  {
    id: 'website_chat',
    name: 'Website Chat',
    description: 'Create and add website chat functionality on your website to engage with visitors and convert prospects into customers.',
    icon: 'https://cdn.simpleicons.org/googlemessages',
    badge: 'Popular',
    badgeColor: 'bg-green-100 text-green-700',
    category: 'livechat'
  },
              ...
              {filteredChannels.map(ch => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="w-12 h-12 rounded-xl bg-gray-50 flex items-center justify-center mb-3 border">
                    ...
                    <div className="opacity-0 group-hover:opacity-100 transition mt-4">

                      <button
                        onClick={() => handleConnect(ch.id)}
                        disabled={isConnecting}
                        className={`group relative w-full py-2 rounded-xl text-sm font-medium border flex items-center justify-center gap-1.5 transition-all duration-300 overflow-hidden
    ${isConnecting
                            ? 'border-blue-300 bg-blue-50 text-blue-500 cursor-not-allowed'
                            : 'border-gray-300 text-gray-700 hover:border-blue-500 hover:text-blue-600 hover:bg-blue-50/50 hover:shadow-[0_2px_12px_rgba(59,130,246,0.15)] active:scale-[0.98]'
                          }`}
                      >
                        {isConnecting ? (
                          <>
                          ...
                          <>
                            <span>Connect</span>
                            <ExternalLink size={13} className="transition-all duration-300 group-hover:translate-x-0.5 group-hover:-translate-y-0.5" />
                          </>
                        )}
                      </button>
