...
export const Contact = createIcon("Contact", Lucide.ContactRound, Phosphor.AddressBook);
...
export const StickyNote = createIcon("StickyNote", Lucide.Notebook, Phosphor.Note);
