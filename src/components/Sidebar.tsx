...
import {
  MessageSquare, LayoutDashboard, Users, Radio, Workflow,
  BarChart3, Plug, UsersRound, Building2, CreditCard, Settings,
  CheckSquare, User, ChevronRight, ChevronLeft, Map, Building,
  UserRound, SquareUserRound, ChartColumnBig, ContactRound, MessageCircleMore,
} from "lucide-react";
...
const navItems: {
  ...
  { icon: LayoutDashboard, label: "Dashboard",  path: "/dashboard",  ws: "ws:dashboard:view"   },
  { icon: MessageCircleMore, label: "Inbox",    path: "/inbox",      ws: "ws:messages:view"    },
  { icon: ContactRound, label: "Contacts",      path: "/contacts",   ws: "ws:contacts:view"    },
    // { icon: Radio, label: "Broadcast", path: "/broadcast" },

  { icon: Workflow, label: "Workflows",          path: "/workflows",  ws: "ws:workflows:view"   },
  { icon: ChartColumnBig, label: "Reports",     path: "/reports",    ws: "ws:reports:view"     },
